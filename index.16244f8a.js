...
toggle.addEventListener('click',function(){
    ...
    if(this.classList.toggle('bi-brightness-high-fill')){
        ...
        project.style.background=' var(--bs-body-bg)'
        project.style.color = 'var(--bs-body-color)'
        hero.style.background='var(--bs-body-bg)'
        hero.style.color = 'var(--bs-body-color)'
        repo1.style.background='var(--bs-body-bg)'
        repo1.style.color = 'var(--bs-body-color)'
        repo2.style.background='var(--bs-body-bg)'
        repo2.style.color = 'var(--bs-body-color)'
        repo3.style.background='var(--bs-body-bg)'
        repo3.style.color = 'var(--bs-body-color)'
        repo4.style.background='var(--bs-body-bg)'
        repo4.style.color = 'var(--bs-body-color)'
    }
    else{
        body.style.background='var(--bs-body-color)'
        body.style.color = 'var(--bs-body-bg)'
        project.style.background='var(--bs-body-color)'
        project.style.color = 'var(--bs-body-bg)'
        hero.style.background='var(--bs-body-color)'
        hero.style.color = 'var(--bs-body-bg)'
        repo1.style.background='var(--bs-body-color)'
        repo1.style.color = 'var(--bs-body-bg)'
        repo2.style.background='var(--bs-body-color)'
        repo2.style.color = 'var(--bs-body-bg)'
        repo3.style.background='var(--bs-body-color)'
        repo3.style.color = 'var(--bs-body-bg)'
        repo4.style.background='var(--bs-body-color)'
        repo4.style.color = 'var(--bs-body-bg)'
    }
})
var t,
  e = {},
      ...
      (t.prototype.onDeviceOrientation = function (t) {
        if (null !== t.gamma && null !== t.beta) {
          ...
          var e =
            ...
            s = e / this.width,
            n = i / this.height,
            a = t.gamma - (this.settings.gyroscopeMinAngleX + this.gammazero),
            o = t.beta - (this.settings.gyroscopeMinAngleY + this.betazero);
          null !== this.updateCall && cancelAnimationFrame(this.updateCall),
            (this.event = {
              clientX: a / s + this.left,
...
"undefined" != typeof document &&
  ((window.VanillaTilt = s), s.init(document.querySelectorAll("[data-tilt]"))),
  (e = s);
const n = [
  {
...
(t = {
  ...
  n.length &&
    ...
    n.forEach(({ element: e, animation: i }) => {
      ScrollReveal().reveal(e, Object.assign({}, t, i));
    })),
  (function () {
    var t;
    let i = document.querySelectorAll(".js-tilt");
    ((t = e) && t.__esModule ? t.default : t).init(i);
  })();
//# sourceMappingURL=index.16244f8a.js.map